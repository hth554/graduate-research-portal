...
function getDefaultProjects() {
    return [
        { id: 1, title: "人工智能驱动的 GEMS 模型部署、验证与应用", category: "ai_model", description: "本课题聚焦人工智能大模型与 GEMS 模型的融合应用，以海南区域为核心研究场景，围绕海洋动力、森林生态两大领域，构建 “模型运行 - AI 部署 - 数据同化 - 实地验证” 的全流程技术体系。", advisor: "刘曙光教授", status: "进行中", statusType: "in-progress", image: "https://s41.ax1x.com/2025/12/29/pZtP2RA.png", createdAt: "2025-12-25", updatedAt: "2025-12-29" },
...
function getDefaultAdvisors() {
    return [
        ...
        { id: 4, name: "郑艺", title: "教授，硕士/博士生导师", field: "植被生产力估算模型、作物制图与产量估算、森林变化的气候效应", bio: "郑艺现任海南大学生态学院副研究员，硕士毕业于中科院遥感与数字地球研究所，博士毕业于中山大学，后在中山大学及法国国家农业食品与环境研究院完成博士后研究，主要研究方向包括植被生产力估算模型、作物制图与产量估算、森林变化的气候效应等，在 Science Advances、ESSD、AFM 等期刊发表论文 20 多篇，其自主研发改进的 EC-LUE 模型所生产的全球长时间序列植被生产力产品获国内外同行认可多次服务于科技部相关年度报告并支撑多篇 Science、Nature 及其子刊的研究。", avatar: "https://s41.ax1x.com/2025/12/29/pZt9sOK.jpg", email: "", website: "", createdAt: "2022-03-05", updatedAt: "2023-10-05" }
    ];
}
