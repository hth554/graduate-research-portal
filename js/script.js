...
const advisorsData = [
    {
        ...
        bio: "国家海外引进高级人才、中组部 “QianRen 计划” 入选者，与中科院合作证实成熟森林土壤可累积碳，推翻经典理论，成果发表于《SCIENCE》并入选 “中国科学 10 大进展”；研发 GEMS 生物地球化学循环模型、SkyCenterESM 生态系统服务核算模型，主导完成美国全域生态系统固碳与减排潜力评估。",
    ...
    },
    {
        ...
        title: "教授，博士生导师",
        field: "城市生态学",
        bio: "她创新性建立了城市化对植被生长影响的理论与定量方法，在 PNAS 发文证实城市环境对植被生长的普遍促进作用，该成果被学界广泛验证应用；提出解释城市化生物多样性梯度的 “热促进和胁迫平衡假说”，构建了我国城市生态系统有机碳储量评估体系，还搭建了北京城乡生态梯度长期研究平台（BES）；主持国家重点研发计划课题、国家自然科学基金等 13 项国家级项目，发表 SCI 论文 80 余篇。",
